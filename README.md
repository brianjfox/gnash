...
2. I wanted to connect people to the fact that the relationship of humans to software is changing drastically.  Humans still need to be the motivating factor behind the existence of the software, and often, we have architectural goals that are larger than a single, or even a suite, of software.  But writing clean and efficient code is no longer the purview of meat-people.  The core of gnash was conceived of, designed, and written in approximately 6 hours of human attention coupled with 10 hours of computational coding.  Since the conception, it has been worked on to get 100% compatibility with GNU Bash, and is getting closer to 100% zsh compatibility with every day!  Please help us get there by submitting issue reports, NOT PRs!  Once the issue is verified, a PR could be welcome!
...
`PREFIX=~/somewhere`, or pin a version with `GNASH_REF=gnash-2.2.4`.
