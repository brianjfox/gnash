...
extern int rl_set_mark (int count, int key);
extern int rl_exchange_point_and_mark (int count, int key);
extern int rl_char_search (int count, int key);
extern int rl_backward_char_search (int count, int key);
...
extern int rl_insert_comment (int count, int key);
extern int rl_clear_display (int count, int key);
extern int rl_do_lowercase_version (int count, int key);
extern int rl_re_read_init_file (int count, int key);
extern int rl_execute_named_command (int count, int key);
...
extern int rl_fetch_history (int count, int key);
extern int rl_operate_and_get_next (int count, int key);
...
extern int rl_vi_undo (int count, int key);
extern int rl_vi_redo (int count, int key);
extern int rl_vi_eof_maybe (int count, int key);
extern int rl_vi_match (int count, int key);
extern int rl_vi_complete (int count, int key);
extern int rl_vi_tilde_expand (int count, int key);
extern int rl_vi_fetch_history (int count, int key);
extern int rl_vi_search (int count, int key);
extern int rl_vi_search_again (int count, int key);
extern int rl_vi_replace (int count, int key);
extern int rl_vi_first_print (int count, int key);
extern int rl_vi_yank_arg (int count, int key);
extern int rl_vi_yank_to (int count, int key);
extern int rl_vi_column (int count, int key);
extern int rl_vi_set_mark (int count, int key);
extern int rl_vi_goto_mark (int count, int key);
extern int rl_vi_unix_word_rubout (int count, int key);
